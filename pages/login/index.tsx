...
const Login = () => {
  return(
    <div className="px-5 py-5 lg:p-0 text-body bg-surface-secondary">
      <div>
        <div className="grid grid-cols-12">
          <div
            className="lg:w-1/3 xl:col-span-4 p-12 xl:p-20 start-0 top-0 h-screen fixed overflow-y-hidden bg-primary hidden lg:flex flex-col">
            {/*Logo*/}
            ...
            <div className="mt-32 mb-20">
              <h1 className="tracking-tight font-bolder text-4.5xl text-white mb-5">
            ...
            {/*Circle*/}
            <div className="w-56 h-56 bg-yellow-500 rounded-full absolute bottom-0 right-20 transform translate-y-1/3"/>
          </div>
          <div
            className="col-span-12 lg:col-span-2 xl:col-span-8 xl:col-start-6 xl:col-end-12 border-left-lg lg:min-h-screen lg:py-16 lg:px-20 relative">
            <div className="grid grid-rows-1 h-full items-center">
              <div className="row-auto">
                <div className="grid grid-cols-12">
                  <div className="lg:col-span-10 md:col-span-9 xl:col-span-7">
                    <div className="mt-10 lg:mt-5 mb-6 flex items-center lg:block">
                      <span className="inline-block lg:block text-4xl lg:mb-6 mr-3">👋</span>
                      <h1 className="tracking-tight font-bolder text-3xl">
                        Nice to see you!
                      </h1>
                    </div>
                    <form>
                    ...
                    " id="email"/>
                      ...
                      bg-formControl
                      border-transparent
                      focus:border-primary focus:bg-white focus:ring-0" id="password"
                      ...
                      <div className="mb-5">
                        <div className="form-check">
                          ...
                          shadow-none
                          mr-2
                        " type="checkbox" name="check_example" id="check_example"/>
                      ...
                      <div>
                        <a href="#" className="transition bg-primary block text-center w-full hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                          Sign in
                        </a>
                      </div>
                    </form>
                    <div className="py-5 text-center">
                      <span className="text-xs uppercase font-semibold">or</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      <div className="col-span-1">
                        <a href="#" className="transition border w-full bg-white hover:bg-formControl text-gray-800 font-bold py-2 px-4 rounded grid justify-items-center">
                          <div className="inline-flex items-center">
                        <span className="icon icon-sm pr-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear" x1="1.07434" y1="7.03731" x2="22.8646"
                                                            y2="17.1983" gradientUnits="userSpaceOnUse">
                        ...
                        <span className="icon icon-sm pr-2">
                                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                          ...
                                          <path opacity="0.2"
                                                ...
                                                fill="white"/>
                                          <defs>
                                              <linearGradient id="paint0_linear" x1="0" y1="12" x2="24" y2="12"
                    ...
                    <div className="my-6">
                      ...
                      <a href="#" className="text-yellow-500 text-sm font-semibold">Sign up</a>
                    </div>
                  </div>
                </div>
              </div>
